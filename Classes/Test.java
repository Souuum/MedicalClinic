...
// // Patient p = new Patient("John", "Doe", "123456789", new Date(),
// "123456789",
// // "Aetna");
...
// "Aetna");
// Patient p1 = new Patient("Hugo", "Soum", "89732193", new Date(), "87889799",
// "Aetna");

// Doctor d = new Doctor("Jane", "Doe", "987654321", new Date(), "987654321",
// "Cardiology");
// Doctor doctor1 = new Doctor("John", "Doe", "123456789", new Date(),
// "123456789", "Cardiology");

// Date d1 = new Date();
// Date d2 = new Date(2023 - 1900, 11, 24); // Date is deprecated and the
// constructor set the year to 1900 + the
...
// // Date db1 = new Date();
// // Doctor d1 = new Doctor("John", "Doe", "123456789", db1, "1234567890",
// "yo",
// // "yo");
// // System.out.println("Test by creating a first patient");
// // System.out.println("-------------------------------");
// // Patient p = new Patient("John", "Doe", "123456789", db1, "1234567890",
// "yo");
